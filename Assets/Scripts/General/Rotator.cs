...
public class Rotator : MonoBehaviour
{
    ...
    public Vector3 forward_offset = Vector3.forward;
    public Vector3 up_offset = Vector3.up;
    Quaternion _facing;
    ...
    public void Init()
    {
        _facing = Quaternion.LookRotation(transform.TransformDirection(-forward_offset), transform.TransformDirection(-up_offset));
    }
    ...
    private IEnumerator TurnToCo(Vector3 direction, bool lockX = true, bool lockY = true, bool lockZ = true, bool follow = false)
    {
        ...
        Quaternion from = Quaternion.LookRotation(transform.TransformDirection(-forward_offset), transform.TransformDirection(-up_offset));
